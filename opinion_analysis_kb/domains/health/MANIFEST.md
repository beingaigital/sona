...
原始 PDF/DOC 保留在学生提交包中；本地知识库采纳版只纳入下列 Markdown 转写，避免把二进制文件带入检索库。
...
**篇数口径**：表 **#1～#15** 为 Wiki/智库对齐，**不计入**领域文档篇数；**#16～#30** 为 zip 归入 `materials/`（及同源路径，其中 **#17～#22** 为《2024 年上半年控烟舆情报告》拆章 **6 条**，与 **#16 目录**同属一份报告）；**第五节 `PH_SUPP_*`** 为自选补充材料（公共卫生事件相关舆情稿，路径 **`opinion_analysis_kb/domains/health/materials/公卫舆情报告补充/`**，结构与 **`10_爱上《浙江宣传》` 等编号 raw** 一致：`#` 标题 + 作者/时间/平台/来源/**链接** + `## 内容`）。按「**仅计 #16～#30 + PH_SUPP 15**」→ **15 + 15 = 30 条**，满足「至少 30 篇领域文档（不计 Wiki）」的 **registry 登记口径**。

| # | id | role | 路径 |
|---|-----|------|------|
| 1 | H_SRC_00_RAW | corpus | `opinion_analysis_kb/references/raw/00_中国舆情大事件记录（持续更新）.md` |
| 2 | H_SRC_00_WIKI | corpus | `opinion_analysis_kb/references/wiki/sources/00_中国舆情大事件记录_持续更新.md` |
| 3 | H_CONCEPT_MED_DISPUTE | concept | `opinion_analysis_kb/references/wiki/concepts/医疗纠纷.md` |
| 4 | H_ENTITY_MED_DISPUTE | entity | `opinion_analysis_kb/references/wiki/entities/医疗纠纷.md` |
| 5 | H_CONCEPT_NB_HOSP | concept | `opinion_analysis_kb/references/wiki/concepts/宁波妇儿医院.md` |
| 6 | H_ENTITY_NB_HOSP | entity | `opinion_analysis_kb/references/wiki/entities/宁波妇儿医院.md` |
| 7 | H_CONCEPT_NB_UNI_WCH | concept | `opinion_analysis_kb/references/wiki/concepts/宁波大学附属妇女儿童医院.md` |
| 8 | H_ENTITY_NB_UNI_WCH | entity | `opinion_analysis_kb/references/wiki/entities/宁波大学附属妇女儿童医院.md` |
| 9 | H_CONCEPT_PUMC | concept | `opinion_analysis_kb/references/wiki/concepts/北京协和医学院.md` |
| 10 | H_ENTITY_PUMC | entity | `opinion_analysis_kb/references/wiki/entities/北京协和医学院.md` |
| 11 | H_ENTITY_XIEHE | entity | `opinion_analysis_kb/references/wiki/entities/协和医学院.md` |
| 12 | H_SRC_HEALTH_AESTHETICS | source | `opinion_analysis_kb/references/wiki/sources/49__lt_逐玉_粉底液将军_被官方点名_电视剧健康审美座谈会_到底在批评谁.md` |
| 13 | H_ENTITY_TEA_BRAND | entity | `opinion_analysis_kb/references/wiki/entities/霸王茶姬.md` |
| 14 | H_CONCEPT_FOOD_SAFETY | concept | `opinion_analysis_kb/references/wiki/concepts/食品安全.md` |
| 15 | H_ENTITY_FOOD_SAFETY | entity | `opinion_analysis_kb/references/wiki/entities/食品安全.md` |
...
| 20 | H_MAT_TOBACCO_2024_H1_CH04 | domain_report | `opinion_analysis_kb/domains/health/materials/控烟相关舆情专题/2024年上半年控烟舆情报告1110_04_四、主流媒体控烟报道的内容分析.md` |
| 21 | H_MAT_TOBACCO_2024_H1_CH05 | domain_report | `opinion_analysis_kb/domains/health/materials/控烟相关舆情专题/2024年上半年控烟舆情报告1110_05_五、_烟卡_舆情专题分析.md` |
| 22 | H_MAT_TOBACCO_2024_H1_CH06 | domain_report | `opinion_analysis_kb/domains/health/materials/控烟相关舆情专题/2024年上半年控烟舆情报告1110_06_附录：重点控烟报道列表.md` |
| 23 | H_MAT_TOBACCO_2024_Q4 | domain_report | `opinion_analysis_kb/domains/health/materials/控烟相关舆情专题/2024年第四季度控烟舆情报告.md` |
| 24 | H_MAT_TOBACCO_2025_ANNUAL | domain_report | `opinion_analysis_kb/domains/health/materials/控烟相关舆情专题/2025年控烟舆情分析年度报告0318.md` |
| 25 | H_MAT_TOBACCO_YANKA | domain_report | `opinion_analysis_kb/domains/health/materials/控烟相关舆情专题/2024年“烟卡”舆情专题分析报告.md` |
| 26 | H_MAT_TOBACCO_2024_ANNUAL | domain_report | `opinion_analysis_kb/domains/health/materials/控烟相关舆情专题/2024年控烟舆情监测年度报告0320.md` |
| 27 | H_MAT_TOBACCO_2024_Q3 | domain_report | `opinion_analysis_kb/domains/health/materials/控烟相关舆情专题/2024第三季度控烟舆情监测报告（20250102）.md` |
...
- **计篇主路径**：**#16～#30**（15 条登记）对应 `materials/` 控烟专题（含目录 + 上半年报告拆章 6 条 + 其余单文件）、公卫参考文献 Markdown 转写；**另加** 第五节 **`PH_SUPP_01`～`15`**（15 条补充材料）。合计登记 **15 + 15 = 30**。  
